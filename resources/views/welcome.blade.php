            ...
            <div class="flex justify-center">
                <svg height="200" width="350" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text style="fill:red;font-size:25px;">
                        <textPath href="#lineAC" textLength="100%" startOffset="20">{{ config('app.name') }}</textPath>
                      
                    </text>
  <circle cx="25" cy="175" r="10" style="fill:red;">
                            <animate attributeName="cx" begin="0s" dur="8s" from="50" to="90%"
                                repeatCount="indefinite" />
                        </circle>                </svg>


                @if(session()->has('message') || session()->has('error') || session()->has('warning') ||
                session()->has('info') || session()->has('success'))
